...
for lamb in listLamb:
	...
	for queueS in listQueueS:
		...
		if(queueS ==128):
			listLoss128 += [((100*link.lost_pkts/tx.packets_sent*1.0)+(100*((link2.lost_pkts/(tx.packets_sent -link.lost_pkts) )*1.0)))]
		...
		print('Loss probability: %.2f%%'%((100*link.lost_pkts/tx.packets_sent*1.0)+(100*((link2.lost_pkts/(tx.packets_sent -link.lost_pkts) )*1.0))))
